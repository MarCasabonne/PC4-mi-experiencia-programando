...
texto = """
Mi nombre es Mar Casabonne, soy peruana y me encuentro estudiando Comunicación Audiovisual en la Pontificia Universidad Católica del Perú. Actualmente estoy en mi quinto ciclo de la carrera y estoy aprendiendo mucho. Tengo 21 años y nací en Cusco, pero vivo en Lima desde hace más de diez años. Estudio audiovisuales porque siempre me interesaron las comunicaciones y el periodismo, pero la idea de aprender a manejar una cámara, el sonido, y aprender a profundidad todas las características cinematográficas me convenció de elegir esta carrera.  Cuando me gradúe de la universidad me gustaría mucho ser directora de documentales y darle a voz a quienes no la tienen. Además, uno de mis sueños es ser corresponsal de guerra. 
...
texto_2 = """
Desde que me gradué del colegio en el 2019 no había tenido una clase de informática. Al enterarme de que debíamos aprender a programar la verdad es que me asuste mucho porque nunca he sido muy buena en informática. A pesar de mi poca experiencia, considero que he aprendido mucho en esta clase durante todo el ciclo. Considero muy importante tener al menos una noción de cómo funciona este mundo ya que es muy importante en mi carrera y es en la dirección en la que se dirige el mundo. 
...
sidebar.markdown("<h1 style='text-align: center;'>Los gráficos que programé este ciclo</h1>", unsafe_allow_html=True)
...
graficos = ['Histograma goles Milan', 'Mapa de Familias lingüísticas', 'Tarjeta rojas de los equipos visitantes']
...
if grafico_seleccionado == 'Histograma goles Milan':
    sidebar.markdown("<div style='text-align: justify; font-size: 20px;'>Aqui hay un dos gráficos de barras que tratan sobre los goles del milan como local y visitante.</div>", unsafe_allow_html=True)
    ...
    sidebar.markdown("<div style='text-align: justify'>Aqui se muestra un mapa de sudamerica con todas las familias linguisticas ubicadas por locación.</div>", unsafe_allow_html=True)
